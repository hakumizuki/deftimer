...
setup(
    ...
    url='https://github.com/hakumizuki/decotimer',
    ...
    package_dir={'': 'decotimer'},
    packages=find_packages(where='decotimer'),
    ...
    project_urls={
        'Bug Reports': 'https://github.com/hakumizuki/decotimer/issues',
        'Source': 'https://github.com/hakumizuki/decotimer/',
    },
)
