...
class TestTimerUseTimerDecorater(unittest.TestCase):
    ...
    def test_use_timer_decorator_without_actions(self):
        ...
        self.assertAlmostEqual(self.timer._global_time, 0.00, 1)
        self.assertAlmostEqual(self.timer._global_paused_time, 0.00, 1)
        self.assertAlmostEqual(self.timer._global_total, 0.00, 1)
    ...
    def test_use_timer_decorator_with_pause_resume(self):
        ...
        self.assertAlmostEqual(self.timer._global_paused_time, 0.50, 1)
        self.assertAlmostEqual(self.timer._global_total, 0.5, 1)
        self.assertAlmostEqual(self.timer.pause_resume[0]['pause'], self.pause_time, 1)
        self.assertAlmostEqual(self.timer.pause_resume[0]['resume'], self.resume_time, 1)
        self.assertEqual(self.timer.blocks, [])
    ...
    def test_use_timer_decorator_with_one_block(self):
        ...
        some_process()
        self.assertTrue(self.timer._start > 0)
        self.assertAlmostEqual(self.timer._end, self.block_end_time, 1)
        self.assertAlmostEqual(self.timer._global_time, 1.0, 1)
        self.assertAlmostEqual(self.timer._global_paused_time, 0.00, 1)
        self.assertAlmostEqual(self.timer._global_total, 0.5, 1)
        self.assertEqual(self.timer.pause_resume, [])
        self.assertAlmostEqual(self.timer.blocks[0]['time'], self.block_end_time - self.block_start_time, 1)
        self.assertAlmostEqual(self.timer._paused_blocked_total, 0.50, 1)
